...
(2171, 145, '2024-08-22 00:00:00', 43001, 1000),
(3022, 578, '2024-08-24 00:00:00', 25852, 4000),
(4933, 145, '2024-08-28 00:00:00', 43001, 7000),
(6322, 248, '2024-08-19 00:00:00', 25852, 2000),
(4717, 578, '2024-08-12 00:00:00', 25852, 7000),
(2172, 145, '2024-09-15 00:00:00', 43001, 8000),
(3023, 578, '2024-09-18 00:00:00', 25852, 3000),
(4934, 145, '2024-09-28 00:00:00', 43001, 9000),
(6323, 248, '2024-09-20 00:00:00', 25852, 1500),
(4718, 578, '2024-09-25 00:00:00', 25852, 6000);
...
FROM
	purchases
WHERE
	date_of_purchase >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH)
GROUP BY user_id
...
SELECT 
    department,
    ROUND(AVG(DATEDIFF(
        IFNULL(end_date, CURRENT_DATE), start_date)), 2) AS avg_duration
FROM 
    employee_service
GROUP BY 
    department;
